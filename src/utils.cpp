...
void help() {
  ...
  std::cout << BOLD << "Sysfex" << RESET << " - another fetch tool written in C++\n" << std::endl;
  std::cout << BOLD << "Flags:" << RESET << std::endl;
  ...
  print("--info <path-to-printables-infos>", "Specify the file from which info will be printed");
}
